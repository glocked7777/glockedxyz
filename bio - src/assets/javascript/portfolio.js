...
const ipgeolocation = 'https://api.ipgeolocation.io/ipgeo?apiKey=e211c0e62709490186f3089a933eacdb';
...
$(document).ready(() => {
  ...
  app.titleChanger(['carti', 'mabu', 'syn', 'professional idiot']);
  app.iconChanger(['assets/icons/roses/rose1.png', 'assets/icons/roses/rose2.png', 'assets/icons/roses/rose3.png', 'assets/icons/roses/rose4.png', 'assets/icons/roses/rose5.png', 'assets/icons/roses/rose6.png', 'assets/icons/roses/rose7.png', 'assets/icons/roses/rose8.png', 'assets/icons/roses/rose1.png']);
});
...
$.getJSON(ipgeolocation, (data) => {
  writeLine(['Authenticating...', "Granting access to <span style='font-size: 14px; color: #06d;'>[unknown]</span>..."], 30, () => {
    ...
    writeLine([`Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>`, `Welcome back, <i style='color: #0f0'>${ip}</i>! By the way, nice to see someone from ${country} here!`], 30, 500, () => {
      ...
      writeLine([`<i style='color: #F62459'>glocked.xyz $$$</i>`], 120, 500, () => {
        timeouts.push(
          setTimeout(() => {
            if (app.skippedIntro) return;
